...
Dataset layout expected (see README — download via Hugging Face or Kaggle;
  legacy S3 telemanom/data.zip is no longer public):
...
class SMAPMSLLoader:
    ...
    def __init__(
        ...
        self.root_dir = str(resolve_path(root_dir))
